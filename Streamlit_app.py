...
# Streamlit appstreamlit run Streamlit_app.py
...
def main():
    ...
    with col1:
        ...
        TT4 = st.number_input('Total Thyroxine (TT4)', min_value=0.0, max_value=300.0, value=100.0, step=1.0)
    ...
    with col2:
        ...
        TSH = st.number_input('TSH (Thyroid Stimulating Hormone)', min_value=0.0, max_value=100.0, value=1.5, step=0.1)
        T4U = st.number_input('T4 Uptake (T4U)', min_value=0.0, max_value=2.5, value=1.0, step=0.01)
    ...
    with col3:
        ...
        T3 = st.number_input('Triiodothyronine (T3)', min_value=0.0, max_value=10.0, value=1.2, step=0.1)
        FTI = st.number_input('Free Thyroxine Index (FTI)', min_value=0.0, max_value=200.0, value=100.0, step=1.0)
